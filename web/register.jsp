        ...
        <div class="dowebok" id="dowebok">
            ...
            <div class="form-container sign-up">
                <form action="<%=request.getContextPath() %>/register" method="post" class="register">
                    ...
                    <input type="text" id="birth" name="birth" placeholder="出生日期 格式“yyyy-MM-dd”" />
            ...
            <div class="form-container sign-in">
                <form action="login" method="post" class="sign">
                    <h1>登录</h1>
                    <input type="text" name="user_id" placeholder="账号" value="${user.user_id}">
